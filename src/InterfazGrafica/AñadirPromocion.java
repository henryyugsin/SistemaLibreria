 ...
 * @author henry
 */
public class AñadirPromocion extends javax.swing.JFrame {

    public AñadirPromocion() {
        initComponents();
        cargarTabla();
        txtid.setText(""+1);
        //Diseño Grafico
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtporcentaje, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE))
    ...
    private void btnañadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnañadirActionPerformed
        ...
        Promocion pro=new Promocion(id,nombre,porcentaje);
        pro.registrar();
        cargarTabla();
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        ...
        pro.consultar();
        txtid.setText(""+id);
        txtnombre.setText(pro.nombre);
        txtporcentaje.setText(pro.porcentaje);
    ...
    private void tblpromocionesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblpromocionesMouseClicked
        ...
        String nombre="";
        String porcentaje="";
        int id=Integer.parseInt(tblpromociones.getValueAt(fila, 0).toString());
        Promocion pro=new Promocion(id,nombre,porcentaje);
        pro.consultar();
        txtid.setText(""+id);
        txtnombre.setText(pro.nombre);
    ...
    DefaultTableModel modeloTabla= (DefaultTableModel) tblpromociones.getModel();
   ...
   modeloTabla.addRow(fila);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirPromocion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AñadirPromocion().setVisible(true);
            }
        });
    }
